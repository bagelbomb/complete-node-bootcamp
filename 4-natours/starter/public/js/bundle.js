...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    popup.setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"));
    popup.addTo(map);
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var savePasswordBtn, currentPasswordField, newPasswordField, newPasswordConfirmField;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            savePasswordBtn = document.querySelector('.btn--save-password');
            currentPasswordField = document.getElementById('password-current');
            newPasswordField = document.getElementById('password');
            newPasswordConfirmField = document.getElementById('password-confirm');
